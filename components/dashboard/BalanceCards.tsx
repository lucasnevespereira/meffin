...
export function BalanceCards({ balance, monthLabel, trendsHref }: BalanceCardsProps) {
  ...
  return (
    <div className="grid gap-4 xl:grid-cols-[minmax(0,1.7fr)_minmax(18rem,0.8fr)]">
      <section className="relative overflow-hidden rounded-2xl border border-border bg-card p-5 shadow-card sm:p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
        <section className="flex flex-col justify-between rounded-2xl border border-emerald-500/25 bg-emerald-500/10 p-4 shadow-card sm:p-5">
        ...
        <section className="flex flex-col justify-between rounded-2xl border border-rose-400/25 bg-rose-500/10 p-4 shadow-card sm:p-5">
          <div className="flex items-center justify-between gap-3">
