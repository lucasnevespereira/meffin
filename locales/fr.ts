export default {
  ...
  transactions_no_shared_annual:
    "Aucune transaction annuelle partagée configurée",
  ...
  profile_delete_dialog_description:
    "Cette action ne peut pas être annulée. Cela supprimera définitivement votre compte et toutes vos données, y compris :",
  ...
  profile_delete_success_description:
  ...
  dashboard_spent_amount: "Dépensé {amount}",
  dashboard_income_context: "sur {amount} de revenus",
  dashboard_spending_progress: "Progression des dépenses du mois",
  dashboard_where_money_went: "Où est parti votre argent",
  dashboard_spending_breakdown_subtitle: "Vos dépenses par catégorie",
  dashboard_view_all: "Tout voir",
  dashboard_transaction_count: "{count} opération(s)",
  ...
  trends_expenses: "Dépenses",
  trends_period_6m: "6M",
  trends_period_12m: "12M",
  trends_period_ytd: "Année",
  ...
  partner_shared_description:
    "Toutes vos transactions, catégories et objectifs budgétaires sont maintenant synchronisés.",
  partner_stop_sharing: "Arrêter le partage",
  partner_no_partner_title: "Aucun partenaire encore",
  partner_no_partner_description:
    "Invitez un partenaire pour gérer votre budget ensemble et voir toutes les transactions partagées.",
  partner_invite_button: "Inviter un partenaire",
  partner_invite_title: "Inviter un partenaire",
  partner_invite_description:
    "Recherchez un utilisateur Meffin par nom ou email pour l'inviter à collaborer sur votre budget.",
  ...
  partner_wants_to_share:
    "Souhaite partager son budget avec vous et collaborer sur vos finances.",
  ...
  partner_invitation_processing:
    "Votre invitation de partenariat budgétaire est en cours de traitement.",
  ...
  partner_remove_dialog_description:
    "Êtes-vous sûr de vouloir arrêter le partage avec {name} ?",
  partner_remove_dialog_warning:
  ...
  transaction_private_description:
    'Vous seul pouvez voir les détails de cette transaction. Votre partenaire verra "Transaction privée".',
  ...
  transaction_edit_permission_denied:
    "Vous ne pouvez modifier que les transactions que vous avez créées",
  transaction_delete_permission_denied:
    "Vous ne pouvez supprimer que les transactions que vous avez créées",

  // Lists Feature
  lists_title: "Listes",
  lists_subtitle:
    "Créez des listes pour vos achats potentiels et convertissez-les en transactions",
  ...
  lists_form_shared_description:
    "Permettre à votre partenaire budgétaire de voir et modifier cette liste",
  ...
  lists_form_category_description:
    "Les éléments ajoutés à cette liste utiliseront cette catégorie par défaut",
  ...
  lists_delete_confirmation:
    "Êtes-vous sûr de vouloir supprimer cette liste ? Cela supprimera également tous les éléments de la liste. Cette action ne peut pas être annulée.",
  lists_deleting: "Suppression...",
  lists_no_category_title: "Aucune catégorie assignée",
  lists_no_category_description:
    "Cette liste a besoin d'une catégorie avant que vous puissiez y ajouter des éléments.",
  ...
  lists_item_delete_confirmation:
    "Êtes-vous sûr de vouloir supprimer cet article ? Cette action est irréversible.",

  // Toast notifications
  lists_item_checked_transaction_created:
    "Article coché et transaction créée !",
  lists_item_unchecked_transaction_deleted:
    "Article décoché et transaction supprimée !",
